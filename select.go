...
// Join adds a JOIN clause to the query.
func (b SelectBuilder) JoinTable(tableName, fieldName string, sourceTable ...string) SelectBuilder {
...
// Join adds a JOIN clause to the query.
func (b SelectBuilder) LeftJoinTable(tableName, fieldName string, sourceTable ...string) SelectBuilder {
...
// Join adds a JOIN clause to the query.
func (b SelectBuilder) RightJoinTable(tableName, fieldName string, sourceTable ...string) SelectBuilder {
